...
class HrExpense(models.Model):
    ...
    def _compute_product_has_cost(self):
        for expense in self:
            ...
            tax_ids = expense.product_id.supplier_taxes_id.filtered_domain(self.env['account.tax'].check_company_domain(expense.company_id))
    ...
    def _compute_tax_ids(self):
        for expense in self:
            ...
            expense.tax_ids = expense.product_id.supplier_taxes_id.filtered_domain(self.env['account.tax'].check_company_domain(expense.company_id))
...
class HrExpenseSheet(models.Model):
    ...
    def _default_journal_id(self):
        ...
        journal = self.env['account.journal'].search([
            *self.env['account.journal'].check_company_domain(default_company_id),
            ('type', '=', 'purchase'),
        ], limit=1)
        return journal.id

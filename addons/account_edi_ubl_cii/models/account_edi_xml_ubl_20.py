...
class AccountEdiXmlUBL20(models.AbstractModel):
    ...
    def _import_fill_invoice_form(self, invoice, tree, qty_factor):
        ...
        def _find_value(xpath, element=tree):
            ...
            return find_xml_value(xpath, element, nsmap)
    ...
    def _import_retrieve_product_map(self, company):
        ...
        return {
            10: lambda tree: with_code_barcode(tree, self.env['product.product'].check_company_domain(company)),
            20: lambda tree: with_code_barcode(tree, []),
            30: lambda tree: with_name(tree, self.env['product.product'].check_company_domain(company)),

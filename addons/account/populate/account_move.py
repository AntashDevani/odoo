...
class AccountMove(models.Model):
    ...
    def _populate_factories(self):
        ...
        def search_accounts(company_id, types=None):
            ...
            """
            domain = [
                *self.env['account.account'].check_company_domain(company_id),
        ...
        def search_journals(company_id, journal_type, currency_id):
            ...
            return self.env['account.journal'].search([
                *self.env['account.journal'].check_company_domain(company_id),
        ...
        def search_products(company_id):
            ...
            return self.env['product.product'].search([
                *self.env['product.product'].check_company_domain(company_id),
        ...
        def search_partner_ids(company_id):
            ...
            return self.env['res.partner'].search([
                *self.env['res.partner'].check_company_domain(company_id),

...
class AccountAccount(models.Model):
    ...
    def _get_most_frequent_accounts_for_partner(self, company_id, partner_id, move_type, filter_never_user_accounts=False, limit=None):
        ...
        """
        domain = [
            *self.env['account.move.line'].check_company_domain(company_id),
    ...
    def copy(self, default=None):
        ...
        try:
            ...
            while self.env['account.account'].search([
                *self.env['account.account'].check_company_domain(default.get('company_id', False) or self.company_id),
                ('code', '=', default['code']),
            ], limit=1):

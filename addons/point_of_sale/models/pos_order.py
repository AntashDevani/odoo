...
class PosOrder(models.Model):
    ...
    def _amount_line_tax(self, line, fiscal_position_id):
        taxes = line.tax_ids.filtered_domain(self.env['account.tax'].check_company_domain(line.order_id.company_id))
...
class PosOrderLine(models.Model):
    ...
    def _onchange_product_id(self):
        if self.product_id:
            ...
            self.tax_ids = self.product_id.taxes_id.filtered_domain(self.env['account.tax'].check_company_domain(self.company_id))
